...
REQUIRED_PHRASES = {
    ...
    "IMPLEMENTATION_CHARTER.md": (
        "Current phase: A5 phase 2 local reference scene scaffold complete",
        "Next phase is A5 phase 3 backend reference-scene runtime smoke",
    ...
    "README.md": (
        "Status: A5 phase 2 local reference scene scaffold complete",
        "WT_TERRAIN_A5_PHASE2_CONTRACT_PASS",
        "WT_TERRAIN_A5_PHASE2_SMOKE_PASS",
    ),
}
